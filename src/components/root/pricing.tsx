        ...
        <Container>
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
              Choose the{" "}
              <span className="font-subheading italic">right plan</span>{" "}
              <br className="hidden lg:block" />
            </h2>
            <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
              Prism OS helps freelancers and agencies automate client
              onboarding, agreements, payments, and progress tracking — saving
              hours of admin work so you can focus on delivering great work.
            </p>
          </div>
        </Container>
