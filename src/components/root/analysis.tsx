      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug">
            User{" "}<span className="font-subheading italic">dashboard</span>
          </h2>
          <p className="text-base md:text-lg text-accent-foreground/80 mt-4">
            Monitor your AI agents handling client proposals, contracts,
            payments, and projects in real-time with actionable insights.
          </p>
        </div>
      </Container>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Track your clients, proposals, and active contracts managed by
                  AI agents.
                </p>
          ...
          <div className="rounded-2xl bg-background/40 relative border border-border/50">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Monitor AI agents’ activity in handling client tasks and
                  workflow efficiency.
                </p>
