      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
            Simplify client <br /> workflows{" "}
            <span className="font-subheading italic">with AI Agents</span>
          </h2>
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            Prism OS provides intelligent AI agents that handle proposals,
            contracts, payments, and project tracking helping you focus on
            great work instead of admin tasks.
          </p>
        </div>
      </Container>
