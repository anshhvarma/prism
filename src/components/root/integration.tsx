...
const SOCIAL_PLATFORMS = [
  ...
  { icon: Icons.x, position: "left-2", size: "medium", iconSize: "medium" },
  { icon: Icons.insta, position: "left-1", size: "large", iconSize: "large" },
  {
    icon: "/images/integration/notion.png",
    position: "right-1",
    size: "large",
    iconSize: "large",
  },
  ...
  {
    icon: "/images/integration/sheet.png",
    position: "right-3",
    size: "small",
    iconSize: "small",
    className: "hidden lg:flex",
...
const Integration = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full py-20 scale-" id="integration">
        ...
        <div className="relative hidden lg:flex items-center justify-center overflow-visible">
          ...
          <div className="absolute z-20 flex items-center justify-center group">
            <Image
              ...
              width={200}
              height={200}
              className="size-32 group-hover:scale-110 transition-all duration-500"
            />
          </div>
