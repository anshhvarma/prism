          ...
          <Container className="relative hidden lg:block overflow-hidden">
            <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
              ...
              <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                ...
                Meet Prism OS – AI Agents for Clients
              </span>
            </button>
          </Container>
          <Container delay={0.15}>
            <h1 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto">
              Simplify your <span className="text-[#8ecaf0] font-normal font-subheading italic">client workflows{"  "}</span>
              with AI Agents
            </h1>
          </Container>
          <Container delay={0.2}>
            <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
              Prism OS gives you intelligent AI agents that handle proposals,
              contracts, payments, and project tracking — so you can focus on
              doing great work, not admin work.
            </p>
          </Container>
